...
class Integer(lineage._Value):
    ...
    def __init__(self, value: int, macro_group: str = ""):
        super().__init__(
...
class Subquery(lineage._Value):
    def __init__(self, value: lineage._Table, macro_group: str = ""):
        super().__init__(
            value=value,
            data_type=value.columns.list_columns_()[0].data_type,
            unit=value.columns.list_columns_()[0].unit,
            macro_group=macro_group,
        )
...
class Raw(lineage._Value):
    def __init__(self, value, macro_group: str = ""):
        super().__init__(value=value, data_type=None, macro_group=macro_group)
